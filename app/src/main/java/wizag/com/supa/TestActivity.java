...
public class TestActivity extends AppCompatActivity {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                                ...
                                for (int k = 0; k < category.length(); k++) {
                                    ...
                                    for (int l = 0; l < quality.length(); l++) {
                                        ...
                                        for (int m = 0; m < size.length(); m++) {
                                            ...
                                            buy_spinner_size.setAdapter(new ArrayAdapter<String>(TestActivity.this, android.R.layout.simple_spinner_dropdown_item, SizeName));
                                        ...
                                        buy_spinner_quality.setAdapter(new ArrayAdapter<String>(TestActivity.this, android.R.layout.simple_spinner_dropdown_item, QualityName));
                                    ...
                                    buy_spinner_category.setAdapter(new ArrayAdapter<String>(TestActivity.this, android.R.layout.simple_spinner_dropdown_item, CategoryName));
                    ...
                    spinner.setAdapter(new ArrayAdapter<String>(TestActivity.this, android.R.layout.simple_spinner_dropdown_item, CountryName));
    ...
    public void loadRequest() {
        ...
        com.android.volley.RequestQueue queue = Volley.newRequestQueue(TestActivity.this);
        final ProgressDialog pDialog = new ProgressDialog(this);
        pDialog.setMessage("Loading...");
        pDialog.show();
