                ...
                new com.android.volley.Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            //persisiting handshake notification
                            Intent in = new Intent(getApplicationContext(), Activity_HandShake.class);
                            @SuppressLint("WrongConstant") PendingIntent pendingIntent = PendingIntent.getActivity(getApplicationContext(), 01, in, Intent.FLAG_ACTIVITY_CLEAR_TASK);
