...
public class Adapter_Indivindual_Sites extends RecyclerView.Adapter<Adapter_Indivindual_Sites.MyViewHolder>  {
    ...
    public Adapter_Indivindual_Sites(List<Model_Indivindual_Sites> data, Context context) {
        this.dataSet = data;
