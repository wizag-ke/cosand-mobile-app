...
public class Supplier_Adapter extends RecyclerView.Adapter<Supplier_Adapter.MyViewHolder> {

    private List<Model_Supplier> dataSet;
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int listPosition) {
        final Model_Supplier supplier = dataSet.get(listPosition);
