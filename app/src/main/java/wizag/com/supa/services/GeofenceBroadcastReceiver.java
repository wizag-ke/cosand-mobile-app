...
public class GeofenceBroadcastReceiver extends BroadcastReceiver {
     ...
     * If the user clicks the notification, control goes to the Activity_Search_Places
     *
    ...
    private void sendNotification(Context context, int transitionType) {
        ...
        Intent notificationIntent = new Intent(context, Activity_Search_Places.class);

        // Construct a task stack.
        TaskStackBuilder stackBuilder = TaskStackBuilder.create(context);

        // Add the main Activity to the task stack as the parent.
        stackBuilder.addParentStack(Activity_Search_Places.class);
